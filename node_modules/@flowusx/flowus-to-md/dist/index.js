...
var _unsupported = (type) => {
  return ({ pageTitle }) => {
    _flowusshared.out.warning(`\u3010${pageTitle}\u3011\u5B58\u5728\u6682\u4E0D\u652F\u6301\u7684\u5757\u7C7B\u578B: ${BlockTypeText[type]}`);
    return "";
  };
};
...
var transform = {
  ...
  [10 /* Grid */]: _unsupported(10 /* Grid */),
  [11 /* Grid_Column */]: _unsupported(11 /* Grid_Column */),
      ...
      firstValue.subNodes.forEach((blockId) => {
        ...
        if (block) {
          ...
          if (!transform[curType]) {
            ...
            mdString += linefeed + transform[curType]({
              block,
