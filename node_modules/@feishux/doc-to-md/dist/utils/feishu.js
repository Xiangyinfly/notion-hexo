...
const getBaseTextValue = (pageTitle, baseData) => {
    let str = '';
    baseData === null || baseData === void 0 ? void 0 : baseData.elements.forEach((item) => {
        if (item.text_run) {
...
const getTodoValue = ({ block, pageTitle }) => {
    ...
    return md.todo(todoStr, (_b = (_a = block.todo) === null || _a === void 0 ? void 0 : _a.style) === null || _b === void 0 ? void 0 : _b.done);
};
/**
 * 无序列表
 * @param block
...
const getTitleValue = (level) => {
    return ({ block, pageTitle }) => {
        ...
        // @ts-ignore
        const headingText = getBaseTextValue(pageTitle, block[key]);
    ...
    if (block.block_type === 15 /* IBlockType.quote */) {
        ...
        const str = (_a = block.children) === null || _a === void 0 ? void 0 : _a.map((id, index) => {
            ...
            if (index === 0 && block.block_type === 19 /* IBlockType.callout */ && ((_a = block.callout) === null || _a === void 0 ? void 0 : _a.emoji_id)) {
                const emoji$1 = emoji.getEmojiChar((_b = block.callout) === null || _b === void 0 ? void 0 : _b.emoji_id);
                return emoji$1 + ' ' + childText;
            }
            return childText;
        }).join('\n');
        return md.quote(str);
...
const getMediaValue = ({ block }) => {
    var _a;
    return md.image('image', (_a = block.image) === null || _a === void 0 ? void 0 : _a.token);
};
/**
 * 代码块
 * @param block
...
const getCodeValue = ({ block }) => {
    ...
    const text = code === null || code === void 0 ? void 0 : code.elements.map((item) => {
