...
class FeiShuClient {
    ...
    _fetch(endpoint, reqOpts) {
        return tslib_es6.__awaiter(this, void 0, void 0, function* () {
            ...
            if (res.data.code !== 0) {
                shared.out.debug('飞书 API 请求失败： ', JSON.stringify(res.data));
                shared.out.err(`飞书 API 请求失败: ${utils.getErrorDesc(res)}`);
                shared.out.warning('请检查飞书应用配置（机器人、wikiId/folderToken）是否配置正常\n配置文档：https://elog.1874.cool/notion/gvnxobqogetukays#%E9%A3%9E%E4%B9%A6');
                process__namespace.exit();
            }
