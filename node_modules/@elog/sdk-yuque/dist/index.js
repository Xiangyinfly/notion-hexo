    ...
    return __async(this, null, function* () {
      ...
      if (res.status !== 200) {
        if (res.status === 404 && ((_a = res.data) == null ? void 0 : _a.message) === "book not found") {
          _shared.out.err("\u914D\u7F6E\u9519\u8BEF", "\u77E5\u8BC6\u5E93\u4E0D\u5B58\u5728\uFF0C\u8BF7\u68C0\u67E5\u914D\u7F6E");
          _shared.out.info("\u8BF7\u53C2\u8003\u914D\u7F6E\u6587\u6863\uFF1Ahttps://elog.1874.cool/notion/write-platform");
        } else {
          _shared.out.err(((_b = res.data) == null ? void 0 : _b.message) || res);
        }
        process.exit();
      }
    ...
    return __async(this, null, function* () {
      ...
      if (res.status !== 200) {
        if (res.status === 404 && ((_c = res.data) == null ? void 0 : _c.message) === "book not found") {
          ...
          _shared.out.err(((_d = res.data) == null ? void 0 : _d.message) || res);
        }
        process.exit();
      }
      return res.data.data;
