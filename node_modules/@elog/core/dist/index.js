...
var _sdkwolai = require('@elog/sdk-wolai'); var _sdkwolai2 = _interopRequireDefault(_sdkwolai);
...
var Elog = class {
  ...
  initWritingPlatform(config) {
    ...
    } else if (config.write.platform === "wolai" /* WOLAI */) {
      let woLaiConfig = config.write.wolai;
      return new (0, _sdkwolai2.default)(woLaiConfig);
    } else {
  ...
  writeArticleCache() {
    ...
    try {
      ...
      } else if (this.config.write.platform === "wolai" /* WOLAI */) {
        const woLaiClient = this.downloaderClient;
    ...
    if (((_a = this.wasteArticles) == null ? void 0 : _a.length) && ((_b = this.cachedArticles) == null ? void 0 : _b.length) && this.config.deploy.platform === _deploy.DeployPlatformEnum.LOCAL) {
      ...
      for (const wasteArticle of this.wasteArticles) {
        ...
        if (fs.existsSync(docRealPath)) {
          ...
          _shared.out.info("\u5220\u9664\u6587\u6863", wasteArticle.realName);
        }
      }
      return true;
    }
