...
import WoLaiClient from '@elog/sdk-wolai';
...
declare class Elog {
    ...
    config: ElogConfig;
    /** 下载器 */
    downloaderClient: YuqueWithToken | YuqueWithPwd | NotionClient__default | FlowUsClient__default | FeiShuClient | WoLaiClient;
    /** 部署器 */
     ...
     * @param config
     */
    initWritingPlatform(config: ElogConfig): YuqueWithToken | YuqueWithPwd | NotionClient__default | FlowUsClient__default | FeiShuClient | WoLaiClient;
    /**
     * 初始化部署平台
     * @param config
     */
