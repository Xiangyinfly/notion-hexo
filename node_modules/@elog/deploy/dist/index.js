      ...
      for (let post of articleList) {
        ...
        if (this.config.catalog) {
          if (Array.isArray(post.catalog)) {
            ...
            postPath = _path2.default.join(outdir, `${fileName}.${this.fileExt}`);
            _shared.out.info("\u751F\u6210\u6587\u6863", `${fileName}.${this.fileExt}`);
          } else {
            _shared.out.warning("\u76EE\u5F55\u7F3A\u5931", `${fileName}\u7F3A\u5931\u76EE\u5F55\u4FE1\u606F\uFF0C\u5C06\u751F\u6210\u5728\u6307\u5B9A\u76EE\u5F55`);
            fileName = this.checkFileName(fileName, fileName, post.doc_id);
            postPath = _path2.default.join(outputDir, `${fileName}.${this.fileExt}`);
            _shared.out.info("\u751F\u6210\u6587\u6863", `${fileName}.${this.fileExt}`);
            ...
            for (const image of urlList) {
              ...
              if (!item) {
                ...
                try {
                  ...
                  _shared.out.info("\u4E0A\u4F20\u6210\u529F", attachment.guid.rendered);
                ...
                _shared.out.info("\u5FFD\u7565\u4E0A\u4F20", `\u56FE\u7247\u5DF2\u5B58\u5728: ${item.guid.rendered}`);
...
exports.DeployPlatformEnum = DeployPlatformEnum; exports.FileExtEnum = FileExtEnum; exports.FileNameEnum = FileNameEnum; exports.FormatEnum = FormatEnum; exports.default = src_default; exports.fileNameList = fileNameList; exports.formatList = formatList;
